...
class ProposalCategory(models.Model):
    name = models.CharField(max_length=255)
    template = models.ForeignKey(Template, related_name='categories', on_delete=models.CASCADE)
...
class ProposalVariable(models.Model):
    ...
    template = models.ForeignKey(Template, related_name='variables', on_delete=models.CASCADE)
...
class ProposalElement(models.Model):
    name = models.CharField(max_length=255)
    category = models.ForeignKey(ProposalCategory, related_name='elements', on_delete=models.CASCADE)
...
class Contract(models.Model):
    ...
    def __str__(self):
        return f"Contract for {self.proposal.name}"
